...
import VGG_architecture as model               ########
...
#tf.app.flags.DEFINE_integer('type_', 18, "type of resnet")
...
tf.app.flags.DEFINE_string('save_name','saved_Vgg_model','folder of saving')
tf.app.flags.DEFINE_integer('validation_interval',1,'validation_interval')
tf.app.flags.DEFINE_integer('type_',16,'typr of vgg')

#tf.app.flags.DEFINE_string('data','MNIST','the data used in training')
#tf.app.flags.DEFINE_string('model_name','AlexNet','the model to be used')
...
def train():
	...
	logits,out_probs=model.network(X,dropout_keep_prob,label_cnt,type_=FLAGS.type_)   ####
